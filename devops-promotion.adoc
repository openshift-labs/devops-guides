...
$ oc create -f https://raw.githubusercontent.com/openshift-labs/devops-labs/master/openshift/coolstore-build-template.yaml 
$ oc create -f https://raw.githubusercontent.com/openshift-labs/devops-labs/master/openshift/coolstore-deployment-template.yaml 
----
