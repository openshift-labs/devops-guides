...
$ oc create -f https://raw.githubusercontent.com/openshift-labs/devops-labs/ocp-3.9/openshift/coolstore-build-template.yaml 
$ oc create -f https://raw.githubusercontent.com/openshift-labs/devops-labs/ocp-3.9/openshift/coolstore-deployment-template.yaml 
----
