...
Due to similarities between Maven and Gradle, the simplest way to start is to create a Dockerfile and build upon the Maven slave image. Here is the content of the https://github.com/openshift-labs/devops-labs/lab-10/blob/ocp-3.7/Dockerfile[Dockerfile on GitHub] for building the Gradle slave image:
...
----
$ oc project ci
$ oc new-build https://github.com/openshift-labs/devops-labs.git#ocp-3.7 --name=jenkins-slave-gradle-rhel7 --context-dir=solutions/lab-10
